...
function Install_initial_system_setting()
    ...
    DoActions(FP, {KillUnit(94, Force2),KillUnit(84, Force2),KillUnit(42, Force2),KillUnit(72, Force2),KillUnit(11, Force2)}, preserved)
    P5_Color = {40, 41, 42, 121}
    P6_Color = {68, 67, 66, 65}
    P7_Color = {60, 59, 58, 57}
    P8_Color = {86, 87, 89, 88}
    ------ Color Setting ----- 
    DoActions(FP, SetDeaths(P11, Add, 1, 1), preserved)
    TriggerX(FP, Deaths(P11, AtLeast, 17, 1), {SetDeaths(P11, SetTo, 1, 1)}, preserved)
    TriggerX(FP, {Deaths(P11, Exactly, 0, 1)}, {
        SetPlayerColor(4, SetTo, P5_Color[1]), -- 40, 41, 42, 121
        SetPlayerColor(5, SetTo, P6_Color[1]), -- 65, 66, 67, 68
        SetPlayerColor(6, SetTo, P7_Color[1]), -- 57, 58, 59, 60
        SetPlayerColor(7, SetTo, P8_Color[1]), -- 86, 87, 89, 88
        SetMinimapColor(4, SetTo, P5_Color[1]),
        SetMinimapColor(5, SetTo, P6_Color[1]),
        SetMinimapColor(6, SetTo, P7_Color[1]),
        SetMinimapColor(7, SetTo, P8_Color[1])
    },preserved)
    TriggerX(FP, {Deaths(P11, Exactly, 3, 1)}, {
        SetPlayerColor(4, SetTo, P5_Color[2]), -- 40, 41, 42, 121
        SetPlayerColor(5, SetTo, P6_Color[2]), -- 65, 66, 67, 68
        SetPlayerColor(6, SetTo, P7_Color[2]), -- 57, 58, 59, 60
        SetPlayerColor(7, SetTo, P8_Color[2]), -- 86, 87, 89, 88
        SetMinimapColor(4, SetTo, P5_Color[2]),
        SetMinimapColor(5, SetTo, P6_Color[2]),
        SetMinimapColor(6, SetTo, P7_Color[2]),
        SetMinimapColor(7, SetTo, P8_Color[2])
    },preserved)
    TriggerX(FP, {Deaths(P11, Exactly, 6, 1)}, {
        SetPlayerColor(4, SetTo, P5_Color[3]), -- 40, 41, 42, 121
        SetPlayerColor(5, SetTo, P6_Color[3]), -- 65, 66, 67, 68
        SetPlayerColor(6, SetTo, P7_Color[3]), -- 57, 58, 59, 60
        SetPlayerColor(7, SetTo, P8_Color[3]), -- 86, 87, 89, 88
        SetMinimapColor(4, SetTo, P5_Color[3]),
        SetMinimapColor(5, SetTo, P6_Color[3]),
        SetMinimapColor(6, SetTo, P7_Color[3]),
        SetMinimapColor(7, SetTo, P8_Color[3])
    },preserved)
    TriggerX(FP, {Deaths(P11, Exactly, 9, 1)}, {
        SetPlayerColor(4, SetTo, P5_Color[4]), -- 40, 41, 42, 121
        SetPlayerColor(5, SetTo, P6_Color[4]), -- 65, 66, 67, 68
        SetPlayerColor(6, SetTo, P7_Color[4]), -- 57, 58, 59, 60
        SetPlayerColor(7, SetTo, P8_Color[4]), -- 86, 87, 89, 88
        SetMinimapColor(4, SetTo, P5_Color[4]),
        SetMinimapColor(5, SetTo, P6_Color[4]),
        SetMinimapColor(6, SetTo, P7_Color[4]),
        SetMinimapColor(7, SetTo, P8_Color[4])
    },preserved)
    TriggerX(FP, {Deaths(P11, Exactly, 12, 1)}, {
        SetPlayerColor(4, SetTo, P5_Color[3]), -- 40, 41, 42, 121
        SetPlayerColor(5, SetTo, P6_Color[3]), -- 65, 66, 67, 68
        SetPlayerColor(6, SetTo, P7_Color[3]), -- 57, 58, 59, 60
        SetPlayerColor(7, SetTo, P8_Color[3]), -- 86, 87, 89, 88
    ...
    TriggerX(FP, {Deaths(P11, Exactly, 15, 1)}, {
        SetPlayerColor(4, SetTo, P5_Color[2]), -- 40, 41, 42, 121
        SetPlayerColor(5, SetTo, P6_Color[2]), -- 65, 66, 67, 68
        SetPlayerColor(6, SetTo, P7_Color[2]), -- 57, 58, 59, 60
        SetPlayerColor(7, SetTo, P8_Color[2]), -- 86, 87, 89, 88
...
function Install_BGMPhase()
    ...
    Trigger { -- 경우 6
        ...
        conditions = {
            ...
            Deaths(CurrentPlayer, Exactly, 0, 220); -- 스타포트 브금 타이머
            Deaths(CurrentPlayer, Exactly, 0, 221); -- 스타게이트 브금 타이머
            Deaths(CurrentPlayer, Exactly, 0, 218); -- 스타게이트 브금 스위치
            Deaths(CurrentPlayer, Exactly, 1, 204); -- 순대 브금 스위치
            Deaths(CurrentPlayer, Exactly, 0, 158); -- 브금온오프
        },
        actions = {
            SetDeaths(CurrentPlayer, SetTo, 2074, 215); -- 스타게이트 브금 타이머
...
function Install_SpecialGunPlotShape()
    ...
    Inf1timeline = {5.5, 13.8, 14.5, 15.2, 15.9, 23.3, 24.7}
    ...
    CAPlotWithProperties(Shell_Arc1, P5, 64,"HealZone", nil, 1, 32, {1,0,0,0,1,0}, nil, P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 10, 62)},nil, nil, StargateProperties)
    CAPlotWithProperties(Shell_Arc2, P6, 70,"HealZone", nil, 1, 32, {1,0,0,0,1,0}, nil, P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 10, 62)},nil, nil, StargateProperties)
    CAPlotWithProperties(Shell_Arc3, P7, 60,"HealZone", nil, 1, 32, {1,0,0,0,1,0}, nil, P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 10, 62)},nil, nil, StargateProperties)
    CAPlotWithProperties(Shell_Arc4, P8, 58,"HealZone", nil, 1, 32, {1,0,0,0,1,0}, nil, P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 10, 62)},nil, nil, StargateProperties)

    CAPlotWithProperties(SH_Arc1, P5, 64,"HealZone", nil, 1, 
    32, {1,0,0,0,1,0}, nil, P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30, 62)},nil, nil, StargateProperties)
    CAPlotWithProperties(SH_Arc2, P6, 70,"HealZone", nil, 1, 32, {1,0,0,0,1,0}, nil, P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30, 62)},nil, nil, StargateProperties)
    CAPlotWithProperties(SH_Arc3, P7, 60,"HealZone", nil, 1, 32, {1,0,0,0,1,0}, nil, P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30, 62)},nil, nil, StargateProperties)
    CAPlotWithProperties(SH_Arc4, P8, 58,"HealZone", nil, 1, 32, {1,0,0,0,1,0}, nil, P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30, 62)},nil, nil, StargateProperties)

    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed, 62)}, {Order(64, P5, "Anywhere", Move, "hive4")})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed, 62)}, {Order(70, P6, "Anywhere", Move, "starg8")})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed, 62)}, {Order(88, P7, "Anywhere", Move, "hive3")})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed, 62)}, {Order(89, P8, "Anywhere", Move, "starg3")})
    
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30 * SDspeed, 62)}, {SetInvincibility(Disable, 64, Force2, "Anywhere")})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed + 1, 62)}, {GiveUnits(All, 70, P6, "Anywhere", P5)})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed + 1, 62)}, {GiveUnits(All, 88, P7, "Anywhere", P5)})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed + 1, 62)}, {GiveUnits(All, 89, P8, "Anywhere", P5)})

    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed - 5, 62)}, {SetInvincibility(Disable, 70, Force2, "Anywhere")})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed - 5, 62)}, {SetInvincibility(Disable, 88, Force2, "Anywhere")})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[1] * SDspeed - 5, 62)}, {SetInvincibility(Disable, 89, Force2, "Anywhere")})
    ...
    TriggerX(P5, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, Inf1timeline[6] * SDspeed, 62)}, {
        Order(64, P5, "Anywhere", Attack, "HealZone"),
        Order(70, P5, "Anywhere", Attack, "HealZone"),
        Order(88, P5, "Anywhere", Attack, "HealZone"),
        Order(89, P5, "Anywhere", Attack, "HealZone")
    })
