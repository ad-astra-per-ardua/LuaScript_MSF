...
function Install_initial_system_setting()
    TriggerX(FP,Always(),{CreateUnit(130, 1, "hive5", P1)}) -- 디버깅용 유닛
...
function MiddleBossTrigger()
    ...
    TriggerX(FP, {Deaths(P11, AtLeast, 1, 164)}, {SetDeaths(P11, SetTo, 0, 164)}, preserved)
    TriggerX(FP, {Deaths(P11, Exactly, 0, 164)}, {Wait(2000),SetInvincibility(Disable, 116, P6, "middle4")}, preserved)
    ...
    CAPlotOrder(CS_Convert(Circulation1,12), P6, 50, "middle4", nil, 1, 32, {1,0,0,0,1,0}, nil,CSMakeCircleX(6,0,30,54,24) , Patrol, "unrevealer2", nil, {1,0}, nil, {0,32}, FP, {CommandLeastAt(148, "middle4"),Deaths(P11, AtLeast, 2040, 163)},nil,{})
    ...
    CAPlotOrder(CS_Convert(CS_Rotate(CS_Reverse(Circulation1),5),12), P6, 50, "middle4", nil, 1, 32, {1,0,0,0,1,0},nil,CSMakeCircleX(6,0,30,54,24), Patrol, "unrevealer2", nil, {1,0}, nil, {0,32}, FP, {CommandLeastAt(148, "middle4"),Deaths(P11, AtLeast, 2040, 163)}, nil, {})
    ...
    CIfOnce(FP,{CommandLeastAt(148, "middle4"),Deaths(P11, AtLeast, 10, 163)})
        ...
        CMov(FP,MBossPtr5,Nextptr) -- Save FBossPtr from Nextptr's 
            CDoActions(FP,{
                ...
                TSetMemory(Vi(Nextptr[2],2),SetTo,256*7000000); -- Next unit pointer offset's HP set
                TSetMemoryX(Vi(Nextptr[2],55),SetTo,0xA00000,0xA00000); -- Next unit pointer offset's status flag set
            })
...
STL1 = {21,8,56,58,70,89,64,96,89,88,7}
    ...
    TriggerX(Force1, {CommandLeastAt(127, "middle3"), Deaths(P11, AtLeast, 10, 166)},{
        RunAIScript('Turn ON Shared Vision for Player 5'),
        RunAIScript('Turn ON Shared Vision for Player 6'),
        RunAIScript('Turn ON Shared Vision for Player 7'),
        RunAIScript('Turn ON Shared Vision for Player 8')
    ...
    CreateLocation = {"starg6","starg7","starp6","starp7"}
    function VerifingPattern1(deathvar) -- Fatal = 9, Safe = 98
        ---- Setting verification section ---
        TriggerX(FP, {CommandLeastAt(127, "middle3"), Deaths(P11, AtLeast, deathvar * SDspeed, 166)}, {CreateUnit(1, 98, CreateLocation[1], P8),CreateUnit(1, 9, "starg7", P8),CreateUnit(1, 9, "starp6", P8),CreateUnit(1, 9, "starp7", P8)})

        ---- Verifing Pattern phase section ----
        TriggerX(FP, {CommandLeastAt(127, "middle3"),  -- Case1 - Failed : fatal pattern1 = Insnare | subtract 1 9 preserved
        ...
        TriggerX(FP, {CommandLeastAt(127, "middle3"),  -- Case2 - Doing nothing. Means 98 : Safe Vessel is Still Alive. -> Bring : fatal pattern1 = Insnare
        Deaths(P11, AtLeast, (deathvar + 6) * SDspeed, 166),
        Bring(P8, AtLeast, 1, 9, "middle3"),
        ...
        Deaths(P11, AtLeast, (deathvar + 6) * SDspeed, 166),
        Bring(P8, Exactly, 0, 9, "middle3")
        },
        {
            KillUnitAt(All, 9, "middle3", P8),
            KillUnitAt(All, 98, "middle3", P8)
        })
        TriggerX(FP, {CommandLeastAt(127, "middle3"),Deaths(P11, AtLeast, (deathvar + 6) * SDspeed, 166)}, {
            KillUnitAt(All, 9, "middle3", P8),
            KillUnitAt(All, 98, "middle3", P8)
        })
    ...
    function VerifingPattern2(deathvar)
        TriggerX(FP, {CommandLeastAt(127, "middle3"), Deaths(P11, AtLeast, deathvar * SDspeed, 166)}, {CreateUnit(1, 9, CreateLocation[1], P8),CreateUnit(1, 98, "starg7", P8),CreateUnit(1, 9, "starp6", P8),CreateUnit(1, 9, "starp7", P8)})

        ---- Verifing Pattern phase section ----
        TriggerX(FP, {CommandLeastAt(127, "middle3"),  -- Case1 - Failed : fatal pattern2 = Broodling | subtract 1 9 preserved
        Deaths(P11, AtLeast, (deathvar) * SDspeed, 166),
        Deaths(P11, AtMost, (deathvar + 6) * SDspeed, 166),
        Deaths(P8, AtLeast, 1, 9)
        },
        ...
        TriggerX(FP, {CommandLeastAt(127, "middle3"),  -- Case2 - Doing nothing. Means 98 : Safe Vessel is Still Alive. -> Bring : fatal pattern2 = Broodling
        Deaths(P11, AtLeast, (deathvar + 6) * SDspeed, 166),
        Bring(P8, AtLeast, 1, 9, "middle3"),
        Bring(P8, Exactly, 1, 98, "middle3")
        },
    ...
    function VerifingPattern3(deathvar)
        TriggerX(FP, {CommandLeastAt(127, "middle3"), Deaths(P11, AtLeast, deathvar * SDspeed, 166)}, {CreateUnit(1, 9, CreateLocation[1], P8),CreateUnit(1, 9, "starg7", P8),CreateUnit(1, 98, "starp6", P8),CreateUnit(1, 9, "starp7", P8)})

        ---- Verifing Pattern phase section ----
        TriggerX(FP, {CommandLeastAt(127, "middle3"),  -- Case1 - Failed : fatal pattern3 = Nuke Battle 4 pic | subtract 1 9 preserved
        Deaths(P11, AtLeast, (deathvar) * SDspeed, 166),
        Deaths(P11, AtMost, (deathvar + 6) * SDspeed, 166),
        Deaths(P8, AtLeast, 1, 9)
        },
        ...
        TriggerX(FP, {CommandLeastAt(127, "middle3"),  -- Case2 - Doing nothing. Means 98 : Safe Vessel is Still Alive. -> Bring : fatal pattern3 = Nuke Battle 4 pic
        Deaths(P11, AtLeast, (deathvar + 6) * SDspeed, 166),
        Bring(P8, AtLeast, 1, 9, "middle3"),
        Bring(P8, Exactly, 1, 98, "middle3")
        },
    ...
    function VerifingPattern4(deathvar)
        TriggerX(FP, {CommandLeastAt(127, "middle3"), Deaths(P11, AtLeast, deathvar * SDspeed, 166)}, {CreateUnit(1, 9, CreateLocation[1], P8),CreateUnit(1, 9, "starg7", P8),CreateUnit(1, 9, "starp6", P8),CreateUnit(1, 98, "starp7", P8)})
    ...
    TriggerX(FP, {CommandLeastAt(127, "middle3")}, {SetDeaths(P8, SetTo, 0, 9)}, preserved)
