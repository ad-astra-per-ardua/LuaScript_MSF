...
function MiddleBossTrigger()
    ...
    CSPlotWithProperties(Shape11_1, P6, 27, M11, nil, 1, 32, P6, {CommandLeastAt(174, "middle1"),Deaths(P11, AtLeast, M11tl[5] * SDspeed, 160)}, nil, nil, Onlyhallucinated)

    TriggerX(FP, {CommandLeastAt(174, "middle1"),Deaths(P11, AtLeast, M11tl[5] * SDspeed, 160)}, CreateUnit(1, 27, , ForPlayer), Flags, Index)
