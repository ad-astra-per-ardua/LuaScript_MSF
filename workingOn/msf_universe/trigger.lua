...
STL1 = {21,8,56,58,70,89,64,96,89,88,7}
    ...
    TriggerX(FP, {Deaths(P11, AtLeast, 1, 167)}, {SetDeaths(P11, SetTo, 0, 167)}, preserved)
    TriggerX(FP, {Deaths(P11, Exactly, 0, 167)}, {Wait(2000),SetInvincibility(Disable, 126, P6, "middle3")}, preserved)
