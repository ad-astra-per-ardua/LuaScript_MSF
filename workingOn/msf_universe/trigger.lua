...
function Install_BGMPhase()
    ...
    Trigger { -- 경우 6
        ...
        actions = {
            SetDeaths(CurrentPlayer, SetTo, 2074, 215); -- 순대 브금 타이머
    ...
    Trigger { -- 경우 7
        ...
        actions = {
            SetDeaths(CurrentPlayer, SetTo, 2074, 215); -- inf1 com 브금 타이머
    ...
    Trigger { -- 경우 8
        ...
        actions = {
            SetDeaths(CurrentPlayer, SetTo, 2074, 164); -- inf2 브금 타이머
