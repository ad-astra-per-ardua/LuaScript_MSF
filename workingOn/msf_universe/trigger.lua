...
SH_Arc1 = CS_RatioXY(CS_FillPathXY(CS_Rotate(ArcTemp, 0),0,15,15,0,0),7,7)
SH_Arc2 = CS_RatioXY(CS_FillPathXY(CS_Rotate(ArcTemp, 90),0,15,15,0,0),7,7)
SH_Arc3 = CS_RatioXY(CS_FillPathXY(CS_Rotate(ArcTemp, 180),0,15,15,0,0),7,7)
SH_Arc4 = CS_RatioXY(CS_FillPathXY(CS_Rotate(ArcTemp, 270),0,15,15,0,0),7,7)
...
function Install_SpecialGunPlotShape()
    ...
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 10 * SDspeed, 62)}, {Order(88, P7, "Anywhere", Move, "hive3")})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 10 * SDspeed, 62)}, {Order(89, P8, "Anywhere", Move, "starg3")})
    
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30 * SDspeed, 62)}, {SetInvincibility(Disable, 64, Force2, "Anywhere")})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30 * SDspeed, 62)}, {GiveUnits(All, 70, P6, "Anywhere", P5)})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30 * SDspeed, 62)}, {GiveUnits(All, 88, P7, "Anywhere", P5)})
    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30 * SDspeed, 62)}, {GiveUnits(All, 89, P8, "Anywhere", P5)})

    TriggerX(Force2, {CommandLeastAt(130, "nuke1"),Deaths(P10, AtLeast, 30 * SDspeed, 62)}, {SetInvincibility(Disable, 70, Force2, "Anywhere")})
