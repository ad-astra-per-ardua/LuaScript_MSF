...
CSPlotOrder(WAVE1, P5, 40, "smallWave", nil, 1, 32, WAVE1, 0, Patrol, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, 1019, 131)},nil,1)
CSPlotOrder(WAVE2, P5, 44, "smallWave", nil, 1, 32, WAVE2, 0, Patrol, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, 1019, 131)},nil,1)
CSPlotOrder(WAVE3, P5, 51, "smallWave", nil, 1, 32, WAVE3, 0, Patrol, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, 1019, 131)},nil,1)
...
Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[1] * SDspeed) - 2, 20)}, {SetScanImage(972)})
for i = 1,8,8 do
	CSPlotWithProperties(LGU1, P8, 65, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(LGU2, P8, 93, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+1] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(LGU3, P8, 66, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+2] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(LGU4, P8, 16, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+3] * SDspeed, 20)},nil,nil,StargateProperties)

	CSPlotWithProperties(SShape1, P8, 89, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+4] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(SShape2, P8, 88, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+5] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(SShape3, P8, 60, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+6] * SDspeed, 20)},nil,nil,StargatePropertiesHero)
	CSPlotOrder(PA, P5, 89, "Stargate1", nil, 1, 32, CSMakePolygon(6,1,0,61,1), 0, Attack, "bunkerHeal",nil , 0, nil, P5, {CommandLeastAt(167, "Stargate1"),Deaths(P10, AtLeast, StargateGenTime[i+7] * SDspeed, 20)})	
	CSPlotWithProperties(PA, P8, 33, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+7] * SDspeed, 20)},nil,nil,StargateProperties)

	Trigger2(P6,{CommandLeastAt(167, "Stargate1"),Deaths(P10, Exactly, StargateGenTime[i+7] * SDspeed + 1, 20) }, {GiveUnits(All,"Men" , P8, "Anywhere", P5),SetInvincibility(Disable, "Men", P5, "Anywhere"),Order("Men", P5, "Anywhere", Attack, "Stargate1")})
end

for i = 9, 16 ,8 do
	CSPlotWithProperties(EllipseArr[1], P8, 65, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(EllipseArr[2], P8, 66, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+1] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(EllipseArr[3], P8, 69, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+2] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(EllipseArr[4], P8, 95, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+3] * SDspeed, 20)},nil,nil,StargateProperties)

	CSPlotWithProperties(EllipseArr[5], P8, 96, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+4] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(EllipseArr[6], P8, 12, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+5] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(EllipseArr[7], P8, 16, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+6] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(EllipseArr[8], P8, 51, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+7] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlot(SH_Flower, P6, 33, "Stargate1", nil, 1, 32, P6,{CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+7] * SDspeed, 20)})

	Trigger2(P6,{CommandLeastAt(167, "Stargate1"),Deaths(P10, Exactly, StargateGenTime[i+7] * SDspeed + 1, 20) }, {GiveUnits(All,"Men" , P8, "Anywhere", P5),SetInvincibility(Disable, "Men", P5, "Anywhere"),Order("Men", P5, "Anywhere", Attack, "Stargate1")})
end
Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[16] * SDspeed) + 5, 20)}, {SetScanImage(546)})

Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[17] * SDspeed) - 2, 20)}, {SetScanImage(972)})
for i = 17, 22, 8 do
	CSPlotWithProperties(LGU4, P8, 65, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(LGU3, P8, 93, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+1] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(LGU2, P8, 66, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+2] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotWithProperties(LGU1, P8, 16, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+3] * SDspeed, 20)},nil,nil,StargateProperties)
	CSPlotOrder(PA, P5, 89, "Stargate1", nil, 1, 32, CSMakePolygon(6,1,0,61,1), 0, Attack, "bunkerHeal",nil , 0, nil, P5, {CommandLeastAt(167, "Stargate1"),Deaths(P10, AtLeast, StargateGenTime[i+4] * SDspeed, 20)})
	CSPlot(Overlapped, P6, 33, "Stargate1", nil, 1, 32, P6,{CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+4] * SDspeed, 20)})

	Trigger2(P6,{CommandLeastAt(167, "Stargate1"),Deaths(P10, Exactly, StargateGenTime[i+4] * SDspeed + 1, 20) }, {GiveUnits(All,"Men" , P8, "Anywhere", P5),SetInvincibility(Disable, "Men", P5, "Anywhere"),Order("Men", P5, "Anywhere", Attack, "Stargate1")})
end
Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[21] * SDspeed) + 5, 20)}, {SetScanImage(546)})

CSPlotOrder(PA, P5, 96, "Stargate1", nil, 1, 32, CSMakePolygon(6,1,0,61,1), 0, Patrol, "etcAcademy1",nil , 0, nil, P5, {CommandLeastAt(167, "Stargate1"),Deaths(P10, AtLeast, StargateGenTime[22] * SDspeed, 20)})

Trigger2(P6, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateEftTime[1] * SDspeed, 20)},
{SetMemoryBA(0x657A9C, SetTo, 8)})
Trigger2(P6, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateEftTime[2] * SDspeed, 20)},
{SetMemoryBA(0x657A9C, SetTo, 31)})
Trigger2(P6, {Deaths(P10, AtLeast, (StargateEftTime[1] * SDspeed)-5, 20)}, {SetScanImage(976)})


CSPlot(StargateEft, P6, 33, "Stargate1", nil, 1, 32, P6,{CommandLeastAt(167, "Stargate1"), Deaths(P10, Exactly, StargateEftTime[1] * SDspeed , 20)})
CSPlot(StargateEft, P6, 33, "Stargate1", nil, 1, 32, P6,{CommandLeastAt(167, "Stargate1"), Deaths(P10, Exactly, StargateEftTime[2] * SDspeed , 20)})

Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[23] * SDspeed)-1, 20)}, {SetScanImage(978)})
CSPlot(StargateEft, P6, 33, "Stargate1", nil, 1, 32, P6,{CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[23] * SDspeed, 20)})

CSPlotOrder(Cross1, P5, 66, "Stargate1", nil, 1, 32, CSMakePolygon(6,1,0,46,0), 0, Attack, "etcAcademy1",nil , 0, nil, P5, {CommandLeastAt(167, "Stargate1"),Deaths(P10, AtLeast, StargateGenTime[23] * SDspeed, 20)})	
