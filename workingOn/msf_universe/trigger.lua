...
function MiddleBossTrigger()
    ...
    Tempshape1 = CSMakeCircleX(6,140,30,54,24)
    TempPerAction = {9,10,13,15,16,17}
    TriggerX(FP, {CommandLeastAt(148, "middle4")}, {SetDeaths(P11, Add, 1, 163)}, preserved)
    -- TriggerX(FP, {CommandLeastAt(148, "middle4"),Deaths(P11, AtLeast, 15, 163)}, {SetScanImage(557)})
    TriggerX(FP, {Always()}, {SetScanImage(557)})
    for i = 1, #TempPerAction do
        TriggerX(FP, Always(), {SetImageColor(557, TempPerAction[i])}, preserved)
    end

    CAPlot(Tempshape1, P6, 33, "middle4", nil, 1, 32, {1,0,0,0,1,0}, nil, FP, {Always()}, nil,1)
