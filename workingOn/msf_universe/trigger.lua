...
Trigger { -- 특건 관련 트리거
	...
	actions = {
		Wait(100);
		SetMemory(0x59CCB0, Add, 400000*256);
		SetMemory(0x6282A0, Add, 400000*256);
...
28.2, 
32.4, 36.2, 40, -- after effects
47.6, 55.3 -- after 2nd effects
}
StargateEftTime = {
	31.5, 31.9, -- reloading effect
	46.7, 47.1 -- 2nd effects
}
...
for i = 1,8,8 do
	...
	CSPlotWithProperties(PA, P8, 84, "Stargate1", nil, 1, 64, P8, {CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+7] * SDspeed, 20)},nil,nil,StargateProperties)
...
for i = 9, 16 ,8 do
	...
	CSPlot(SH_Flower, P6, 84, "Stargate1", nil, 1, 32, P6,{CommandLeastAt(167, "Stargate1"), Deaths(P10, AtLeast, StargateGenTime[i+7] * SDspeed, 20)})
...
CSPlotOrder(PA, P5, 96, "Stargate1", nil, 1, 32, CSMakePolygon(6,1,0,61,1), 0, Attack, "bunkerHeal",nil , 0, nil, P5, {CommandLeastAt(167, "Stargate1"),Deaths(P10, AtLeast, StargateGenTime[22] * SDspeed, 20)})
