...
function Install_initial_system_setting()
    -- TriggerX(FP,Always(),{CreateUnit(1, 80, "HealZone", P1)}) -- for debugging
...
function MiddleBossTrigger()
    ...
    TriggerX(FP, {Deaths(P11, AtLeast, 1, 225)}, {SetDeaths(P11, SetTo, 0, 225)}, preserved)
    TriggerX(FP, {Deaths(P11, Exactly, 0, 225)}, {Wait(2000),SetInvincibility(Disable, 22, P6, "middle1")}, preserved)
    ...
    TriggerX(FP, {Deaths(P12, AtLeast, 1, 226)}, {SetDeaths(P12, SetTo, 0, 226)}, preserved)
    TriggerX(FP, {Deaths(P12, Exactly, 0, 226)}, {Wait(2000),SetInvincibility(Disable, 68, P6, "middle2")}, preserved)
...
STL1 = {21,8,56,58,70,89,64,96,89,88,7}
    ...
    TriggerX(Force1, {CommandLeastAt(127, "middle3"), Deaths(P6, Exactly, 1, 126)}, {
        PlayWAV("staredit\\wav\\BOSSClear.ogg"),
        PlayWAV("staredit\\wav\\BOSSClear.ogg"),
        PlayWAV("staredit\\wav\\BOSSClear.ogg"),
...
function FinalBossTrigger()
    ----------- After 4 MBoss ---------
    TriggerX(FP, {Deaths(P6, Exactly, 4, 15)}, {
    ...
    TriggerX(FP,{Deaths(P6, Exactly, 4, 15),Deaths(P7, Exactly, 1, 168)},{
        RotatePlayer({
