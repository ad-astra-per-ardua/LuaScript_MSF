__MapDirSetting("C:\\Users\\rlatj\\Desktop\\workingarea\\mapping\\MSF_U") -- 맵파일 경로(\를 \\로 바꿔야함)
__SubDirSetting("C:\\Users\\rlatj\\Desktop\\workingarea\\mapping\\MSF_U") -- Main.lua 폴더경로 (\를 \\로 바꿔야함, 없으면 비우기)
...
for e = 2,8 do
	CSPlotOrder(CS_Rotate(LGU1,10*(e-1)), P7, 84, "Hive4", {1760,2544}, 1, 20, CS_Rotate(LGU1,10*(e-1)), 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive4"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,13)})
	...
	CSPlotOrder(CS_Rotate(LGU3,10*(e-1)), P7, 84, "Hive4", {1760,2544}, 1, 20, CS_Rotate(LGU3,10*(e-1)), 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive4"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,13)})

	CSPlotOrder(CS_Rotate(LGU1,10*(e-1)), P7, 51, "Hive4", {1760,2544}, 1, 20, CS_Rotate(LGU1,10*(e-1)), 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive4"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,13)})
	...
	CSPlotOrder(CS_Rotate(LGU3,10*(e-1)), P7, 46, "Hive4", {1760,2544}, 1, 20, CS_Rotate(LGU3,10*(e-1)), 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive4"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,13)})
end
