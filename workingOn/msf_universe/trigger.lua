...
STL1 = {21,8,56,58,70,89,64,96,89,88,7}
    ...
    function VerifingPattern(deathvar) -- Fatal = 180, Safe = 181
        TriggerX(FP, {CommandLeastAt(127, "middle3"), Deaths(P11, AtLeast, deathvar * SDspeed, 166)}, {CreateUnit(1, 180, "starg6", P1),CreateUnit(1, 180, "starg7", P1),CreateUnit(1, 180, "starp6", P1),CreateUnit(1, 180, "starp7", P1)} )
        -- TriggerX(FP, {CommandLeastAt(127, "middle3"), Deaths(P11, AtLeast, deathvar * SDspeed + 1, 166)}, {} )
