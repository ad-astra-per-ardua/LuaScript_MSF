...
for e = 2,8 do
	CSPlotOrder(CS_Rotate(LGU1,5*(e-1)), P7, 84, "Hive1", {992,1872}, 1, 20, LGU1, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})
	CSPlotOrder(CS_Rotate(LGU2,5*(e-1)), P6, 84, "Hive1", {992,1872}, 1, 20, LGU2, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})
	CSPlotOrder(CS_Rotate(LGU3,5*(e-1)), P7, 84, "Hive1", {992,1872}, 1, 20, LGU3, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})

	CSPlotOrder(CS_Rotate(LGU1,5*(e-1)), P7, 51, "Hive1", {992,1872}, 1, 20, LGU1, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})
	CSPlotOrder(CS_Rotate(LGU2,5*(e-1)), P6, 16, "Hive1", {992,1872}, 1, 20, LGU2, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})
	CSPlotOrder(CS_Rotate(LGU3,5*(e-1)), P7, 46, "Hive1", {992,1872}, 1, 20, LGU3, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})
end
