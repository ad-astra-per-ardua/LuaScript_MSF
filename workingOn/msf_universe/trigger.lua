...
for i = 1, #Physics do
	Trigger2(P7, {CommandLeastAt(118, Physics[i])}, {
		CreateUnit(9, 12, Physics[i], P6),
		CreateUnit(1, 28, Physics[i], P6),
		CreateUnit(6, 8, Physics[i], P6),
		Order("Any unit", P6, Physics[i], Attack, "bunkerHeal"),
	})
end


for i = 1, #MachineShop do
	Trigger2(P7, {CommandLeastAt(120, MachineShop[i])}, {
		CreateUnit(9, 19, MachineShop[i], P6),
		CreateUnit(1, 21, MachineShop[i], P6),
		CreateUnit(6, 12, MachineShop[i], P6),
...
for i = 1, #Reaver do
	Trigger2(P7, {CommandLeastAt(171, Reaver[i])}, {
        CreateUnit(6, 81, Reaver[i], P6), 
        CreateUnit(1, 70, Reaver[i], P6),
        CreateUnit(1, 86, Reaver[i], P6),
        Order("Any unit", P6, Reaver[i], Attack, "bunkerHeal")})
end


for i = 1, #Arbiter do
	Trigger2(P7, {CommandLeastAt(170, Arbiter[i])}, {
	CreateUnit(9, 88, Arbiter[i], P6),
	CreateUnit(1, 86, Arbiter[i], P6),
	CreateUnit(3, 58, Arbiter[i], P6),
	CreateUnit(3, 60, Arbiter[i], P6),
	Order("Any unit", P6, Arbiter[i], Attack, "bunkerHeal"),
	})
end


for i = 1, #Armory do
	Trigger2(P7, {CommandLeastAt(123, Armory[i])}, {
...
for i = 1, #Academy do
	Trigger2(P7, {CommandLeastAt(112, Academy[i])}, {
...
CSPlotOrder(WAVE1, P7, 40, "smallWave", nil, 1, 32, WAVE1, 0, Patrol, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, 1019, 131)},nil,1)
CSPlotOrder(WAVE2, P7, 44, "smallWave", nil, 1, 32, WAVE2, 0, Patrol, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, 1019, 131)},nil,1)
CSPlotOrder(WAVE3, P7, 51, "smallWave", nil, 1, 32, WAVE3, 0, Patrol, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, 1019, 131)},nil,1)
...
for j = 15, 0, -1 do
		TriggerX(Force1,{Score(CurrentPlayer,Kills,AtLeast,2^j*100)},{
			...
			SetResources(CurrentPlayer,Add,2^j*ExRate[1],Ore);
		},{Preserved})
end
...
Trigger { -- 특건 관련 트리거
	...
	actions = {
		Wait(100);
		SetMemory(0x59CCB0, SetTo, 400000*256);
		SetMemory(0x6282A0, SetTo, 400000*256);
...
for i = 1 , 10 do
	...
	CSPlotOrder(Bigwave1, P6, 54, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 53, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 55, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 56, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i, 132)},nil,1)
	CSPlotOrder(Bigwave2, P6, 62, "celebrate1", nil, 1, 32, CSMakeLine(6,1,0,13,0), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i, 132)},nil,1)
end
...
for i = 10, 15 do
	...
	CSPlotOrder(Bigwave1, P6, 65, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 120, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 66, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 120, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 51, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 120, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 88, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 120, 132)},nil,1)
	CSPlotOrder(Bigwave2, P6, 70, "celebrate1", nil, 1, 32, CSMakeLine(6,1,0,13,0), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 120, 132)},nil,1)
end
...
for i = 16, 20 do
	...
	CSPlotOrder(Bigwave1, P6, 77, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 78, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 104, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)},nil,1)
	CSPlotOrder(Bigwave1, P6, 88, "celebrate1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)},nil,1)
	CSPlotOrder(Bigwave2, P6, 64, "celebrate1", nil, 1, 32, CSMakeLine(6,1,0,13,0), 0, Attack, "bunkerHeal", nil, 64, nil, P6,{Deaths(P8, Exactly, Gentime * i + 180, 132)},nil,1)
end
...
function HatcheryGunplot( Hatname, Deathvar)
Trigger{
    players = {P6},
    conditions = {
...
CSPlotOrder(square1, P6, 54, Hatname, nil, 1, 16, square1, 0, Attack, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 50,Deathvar)})
CSPlotOrder(square1, P7, 53, Hatname, nil, 1, 16, square1, 0, Attack, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 85, Deathvar)})
CSPlotOrder(square1, P6, 40, Hatname, nil, 1, 16, square1, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 115, Deathvar)})
CSPlotOrder(spiral1, P6, 43, Hatname, nil, 1, 10, spiral1, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 180, Deathvar)})
CSPlotOrder(square1, P7, 39, Hatname, nil, 1, 16, square1, 0, Patrol, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 145, Deathvar)})

CSPlotOrder(spiral1, P7, 43, Hatname, nil, 1, 12, spiral1, 0, Patrol, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 275, Deathvar)})
CSPlotOrder(spiral2, P6, 44, Hatname, nil, 1, 12, spiral2, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 345, Deathvar)})
CSPlotOrder(spiral1, P7, 43, Hatname, nil, 1, 12, spiral1, 0, Patrol, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 415, Deathvar)})
CSPlotOrder(spiral2, P6, 44, Hatname, nil, 1, 12, spiral2, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 485, Deathvar)})

-- -- Hat1 hatchery phase 2
CSPlotOrder(square2, P7, 54, Hatname, nil, 1, 20, square2, 0, Attack, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 578, Deathvar)})
CSPlotOrder(square2, P6, 53, Hatname, nil, 1, 20, square2, 0, Attack, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 613, Deathvar)})
CSPlotOrder(spiral1, P7, 43, Hatname, nil, 1, 12, spiral1, 0, Patrol, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 640, Deathvar)})
CSPlotOrder(spiral2, P6, 44, Hatname, nil, 1, 12, spiral2, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 691, Deathvar)})
CSPlotOrder(square2, P6, 39, Hatname, nil, 1, 20, square2, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, Hatname), Deaths(P10, AtLeast, 691, Deathvar)})
end

local Hatname = "Hat1"
local Deathvar = 0
HatcheryGunplot(Hatname, Deathvar)
...
players = {P6},
conditions = {
    CommandLeastAt(131, "Hat5");
},
actions = {
    SetDeaths(P10,Add,1,24);
    PreserveTrigger();
}
}
-- Hat5 hatchery phase 1
CSPlotOrder(square1, P6, 54, "Hat5", nil, 1, 16, square1, 0, Attack, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 50,24)})
CSPlotOrder(square1, P7, 53, "Hat5", nil, 1, 16, square1, 0, Attack, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 85, 24)})
CSPlotOrder(square1, P6, 51, "Hat5", nil, 1, 16, square1, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 115, 24)})
CSPlotOrder(spiral1, P6, 16, "Hat5", nil, 1, 10, spiral1, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 180, 24)})
CSPlotOrder(square1, P7, 65, "Hat5", nil, 1, 16, square1, 0, Patrol, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 145, 24)})

CSPlotOrder(spiral1, P7, 55, "Hat5", nil, 1, 12, spiral1, 0, Patrol, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 275, 24)})
CSPlotOrder(spiral2, P6, 56, "Hat5", nil, 1, 12, spiral2, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 345, 24)})
CSPlotOrder(spiral1, P7, 55, "Hat5", nil, 1, 12, spiral1, 0, Patrol, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 415, 24)})
CSPlotOrder(spiral2, P6, 56, "Hat5", nil, 1, 12, spiral2, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 485, 24)})

-- -- Hat5 hatchery phase 2
CSPlotOrder(square2, P7, 51, "Hat5", nil, 1, 20, square2, 0, Attack, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 578, 24)})
CSPlotOrder(square2, P6, 16, "Hat5", nil, 1, 20, square2, 0, Attack, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 613, 24)})
CSPlotOrder(spiral1, P7, 55, "Hat5", nil, 1, 12, spiral1, 0, Patrol, "bunkerHeal", nil, 0, nil, P7,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 640, 24)})
CSPlotOrder(spiral2, P6, 56, "Hat5", nil, 1, 12, spiral2, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 691, 24)})
CSPlotOrder(square2, P6, 65, "Hat5", nil, 1, 20, square2, 0, Patrol, "bunkerHeal", nil, 0, nil, P6,{CommandLeastAt(131, "Hat5"), Deaths(P10, AtLeast, 691, 24)})
...
---- 1젠 ----
CSPlotOrder(LGU1, P6, 39, Lairname, nil, 1, 20, LGU1a, 0, Patrol , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[1] * SDspeed,Deathvar)})
CSPlotOrder(LGU2, P6, 51, Lairname, nil, 1, 20, LGU2a, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[1] * SDspeed,Deathvar)})
CSPlotOrder(LGU3, P6, 46, Lairname, nil, 1, 20, LGU3a, 0, Patrol , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[1] * SDspeed,Deathvar)})
CSPlotOrder(LSU, P6, 43, Lairname, nil, 1, 20, LSU, 0, Patrol , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[1] * SDspeed,Deathvar)})
CSPlotOrder(LSU2, P6, 44, Lairname, nil, 1, 20, LSU2, 0, Patrol , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[1] * SDspeed,Deathvar)})

---2젠
CSPlotOrder(LGU1, P6, 39, Lairname, nil, 1, 20, LGU1, 0, Patrol , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[2] * SDspeed,Deathvar)})
CSPlotOrder(LGU2, P7, 51, Lairname, nil, 1, 20, LGU2, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[2] * SDspeed,Deathvar)})
CSPlotOrder(LGU3, P6, 46, Lairname, nil, 1, 20, LGU3, 0, Patrol , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[2] * SDspeed,Deathvar)})
CSPlotOrder(LSU, P7, 43, Lairname, nil, 1, 20, LSU, 0, Patrol , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[2] * SDspeed,Deathvar)})
CSPlotOrder(LSU2, P6, 44, Lairname, nil, 1, 20, LSU2, 0, Patrol , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[2] * SDspeed,Deathvar)})
--- 3젠
CSPlotOrder(LGU1, P7, 16, Lairname, nil, 1, 20, LGU1, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[3] * SDspeed,Deathvar)})
CSPlotOrder(LGU2, P6, 51, Lairname, nil, 1, 20, LGU2, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[3] * SDspeed,Deathvar)})
CSPlotOrder(LGU3, P7, 46, Lairname, nil, 1, 20, LGU3, 0, Patrol , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[3] * SDspeed,Deathvar)})
CSPlotOrder(LSU, P6, 43, Lairname, nil, 1, 20, LSU, 0, Patrol , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[3] * SDspeed,Deathvar)})
CSPlotOrder(LSU2, P7, 16, Lairname, nil, 1, 20, LSU2, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[3] * SDspeed,Deathvar)})
...
CSPlotOrder(LGU1, P7, 51, Lairname, nil, 1, 20, LGU1, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[9] * SDspeed,Deathvar)})
CSPlotOrder(LGU2, P6, 16, Lairname, nil, 1, 20, LGU2, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[9] * SDspeed,Deathvar)})
CSPlotOrder(LGU3, P7, 46, Lairname, nil, 1, 20, LGU3, 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[9] * SDspeed,Deathvar)})
CSPlotOrder(LSU, P6, 43, Lairname, nil, 1, 20, LSU, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[9] * SDspeed,Deathvar)})
...
CSPlotOrderWithProperties(sixline, P6, 44, Lairname, nil, 1, 20, sixline, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[10] * SDspeed,Deathvar)},nil,0,TempProperties)

CSPlot(LGU1, P6, 94, Lairname, nil, 1, 20, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[10] * SDspeed,Deathvar)})
CSPlotOrderWithProperties(LGU1, P6, 43, Lairname, nil, 1, 20, LGU1, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[11] * SDspeed,Deathvar)},nil,0,TempProperties)

CSPlot(LGU2, P6, 94, Lairname, nil, 1, 20, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[11] * SDspeed,Deathvar)})
CSPlotOrderWithProperties(LGU2, P6, 44, Lairname, nil, 1, 20, LGU2, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[12] * SDspeed,Deathvar)},nil,0,TempProperties)

CSPlot(LGU3, P6, 94, Lairname, nil, 1, 20, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[12] * SDspeed,Deathvar)})
CSPlotOrderWithProperties(LGU3, P6, 62, Lairname, nil, 1, 20, LGU3, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[13] * SDspeed,Deathvar)},nil,0,TempProperties)
...
CSPlotOrderWithProperties(Eftstar, P6, 43, Lairname, nil, 1, 20, Eftstar, 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(132, Lairname), Deaths(P10, AtLeast, LairTimeline[14] * SDspeed,Deathvar)},nil,0,TempProperties)

end

local Lairname = "Lair1"
local Deathvar = 6
LairGunplot(Lairname, Deathvar)

local Lairname = "Lair2"
local Deathvar = 7
LairGunplot(Lairname, Deathvar)

local Lairname = "Lair3"
local Deathvar = 8
LairGunplot(Lairname, Deathvar)

local Lairname = "Lair4"
local Deathvar = 9
LairGunplot(Lairname, Deathvar)
...
Trigger2(P6, {Deaths(P10, AtLeast, 1, 10)}, {SetScanImage(213)})
...
CSPlotWithProperties(Line2, P6, 33, "Hive1", nil, 1, 32, P6, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveEftTime[i] * SDspeed, 10)},nil,0,EftProperties)
end
...
for e = 2,8 do
CSPlotOrder(CS_Rotate(LGU1,10*(e-1)), P7, 33, "Hive1", nil, 1, 20, CS_Rotate(LGU1,10*(e-1)), 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})
CSPlotOrder(CS_Rotate(LGU2,10*(e-1)), P6, 33, "Hive1", nil, 1, 20, CS_Rotate(LGU2,10*(e-1)), 0, Attack , "bunkerHeal", nil, 0, nil, P6, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})
CSPlotOrder(CS_Rotate(LGU3,10*(e-1)), P7, 33, "Hive1", nil, 1, 20, CS_Rotate(LGU3,10*(e-1)), 0, Attack , "bunkerHeal", nil, 0, nil, P7, {CommandLeastAt(133, "Hive1"), Deaths(P10, AtLeast, HiveGenTime2[e] * SDspeed,10)})
...
Trigger2(P6, {Deaths(P10, AtLeast, 1, 11)}, {SetScanImage(213)})
...
Trigger2(P6, {Deaths(P10, AtLeast, 1, 12)}, {SetScanImage(213)})
...
Trigger2(P6, {Deaths(P10, AtLeast, 1, 14)}, {SetScanImage(213)})
...
Trigger2(P6, {Deaths(P10, AtLeast, 1, 15)}, {SetScanImage(213)})
...
Trigger2(P6, {CommandLeastAt(114, "Starport4"),Deaths(P10, Exactly, 2, 16)}, {SetScanImage(971)})

for i = 1, 12, 2 do
Trigger2(P6, {CommandLeastAt(114, "Starport4"),Deaths(P10, Exactly, Starport_gen[i] * SDspeed, 16)}, {SetScanImage(971)})
CSPlot(PA, P6, 33, "Starport4", nil, 1, 64, P5, {CommandLeastAt(114, "Starport4"),Deaths(P10, AtLeast, Starport_gen[i] * SDspeed, 16)})
CSPlotOrder(PA, P6, 16, "Starport4", nil, 1, 64, PAA, 0, Attack, "bunkerHeal",nil , 0, nil, P6, {CommandLeastAt(114, "Starport4"),Deaths(P10, AtLeast, Starport_gen[i] * SDspeed, 16)})
CSPlotOrder(PB, P6, 66, "Starport4", nil, 1, 64, PBA, 0, Patrol, "bunkerHeal",nil , 0, nil, P6, {CommandLeastAt(114, "Starport4"),Deaths(P10, AtLeast, Starport_gen[i] * SDspeed, 16)})
CSPlotOrder(PC, P6, 65, "Starport4", nil, 1, 64, PCA, 0, Patrol, "bunkerHeal",nil , 0, nil, P6, {CommandLeastAt(114, "Starport4"),Deaths(P10, AtLeast, Starport_gen[i] * SDspeed, 16)})
end
for e = 2, 12, 4 do
Trigger2(P6, {CommandLeastAt(114, "Starport4"),Deaths(P10, Exactly, Starport_gen[e] * SDspeed, 16)}, {SetScanImage(971)})
CSPlot(PE, P6, 33, "Starport4", nil, 1, 64, P5, {CommandLeastAt(114, "Starport4"), Deaths(P10, Exactly, Starport_gen[e] * SDspeed, 16)})
CSPlotOrder(PE, P6, 56, "Starport4", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal",nil , 0, nil, P6, {CommandLeastAt(114, "Starport4"),Deaths(P10, AtLeast, Starport_gen[e] * SDspeed, 16)})
end

for r = 4, 12, 4 do
CSPlotOrder(PE, P6, 55, "Starport4", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Attack, "bunkerHeal",nil , 0, nil, P6, {CommandLeastAt(114, "Starport4"),Deaths(P10, AtLeast, Starport_gen[r] * SDspeed, 16)})
end
Trigger2(P6,{CommandLeastAt(114, "Starport4"), Deaths(P10, Exactly, Starport_gen[12]* SDspeed + 1, 16)}, {SetScanImage(546)})
...
Trigger2(P6, {CommandLeastAt(114, "Starport1"),Deaths(P10, Exactly, 2, 17)}, {SetScanImage(971)})
for i = 1, 12, 2 do
Trigger2(P6, {CommandLeastAt(114, "Starport1"),Deaths(P10, Exactly, Starport_gen[i] * SDspeed, 17)}, {SetScanImage(971)})
CSPlot(PA, P6, 33, "Starport1", nil, 1, 64, P5, {CommandLeastAt(114, "Starport1"), Deaths(P10, Exactly, Starport_gen[i] * SDspeed, 17)})
...
for e = 2, 12, 4 do
Trigger2(P6, {CommandLeastAt(114, "Starport1"),Deaths(P10, Exactly, Starport_gen[e] * SDspeed, 17)}, {SetScanImage(971)})
CSPlot(PE, P6, 33, "Starport1", nil, 1, 64, P5, {CommandLeastAt(114, "Starport1"), Deaths(P10, Exactly, Starport_gen[e] * SDspeed, 17)})
CSPlotOrder(PE, P6, 96, "Starport1", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Patrol, "bunkerHeal",nil , 0, nil, P6, {CommandLeastAt(114, "Starport1"),Deaths(P10, AtLeast, Starport_gen[e] * SDspeed, 17)})
end
...
Trigger2(P6, {Deaths(P10, Exactly, (Starport_gen[12] * SDspeed) + 1, 17)}, {SetScanImage(546)})
...
for i = 1 , 31 do
Trigger2(P6, {CommandLeastAt(114, "Starport2"),CommandLeastAt(114, "Starport2"), Deaths(P10, AtLeast, i, 18)} , {SetMemoryBA(0x657A9C, SetTo, i)})
end

Trigger2(P6, {CommandLeastAt(114, "Starport2"),Deaths(P10, Exactly, 2, 18)}, {SetScanImage(971)})
for i = 1, 12, 2 do
Trigger2(P6, {Deaths(P10, Exactly, Starport_gen[i] * SDspeed, 18)}, {SetScanImage(971)})
CSPlot(PA, P6, 33, "Starport2", nil, 1, 64, P5, {CommandLeastAt(114, "Starport2"), Deaths(P10, Exactly, Starport_gen[i] * SDspeed, 18)})
...
for e = 2, 12, 4 do
Trigger2(P6, {CommandLeastAt(114, "Starport2"),Deaths(P10, Exactly, Starport_gen[e] * SDspeed, 18)}, {SetScanImage(971)})
CSPlot(PE, P6, 33, "Starport2", nil, 1, 64, P5, {CommandLeastAt(114, "Starport2"), Deaths(P10, Exactly, Starport_gen[e] * SDspeed, 18)})
CSPlotOrder(PE, P6, 96, "Starport2", nil, 1, 32, CSMakePolygon(6,1,0,91,1), 0, Patrol, "bunkerHeal",nil , 0, nil, P6, {CommandLeastAt(114, "Starport2"),Deaths(P10, AtLeast, Starport_gen[e] * SDspeed, 18)})
end
...
Trigger2(P6,{CommandLeastAt(114, "Starport2"), Deaths(P10, Exactly, (Starport_gen[12] * SDspeed) + 1, 18)}, {SetScanImage(546)})
...
Trigger2(P6, {CommandLeastAt(114, "Starport3"),Deaths(P10, AtLeast, 2, 19)}, {SetScanImage(971)})
...
for i = 1, 12, 2 do
Trigger2(P6, {CommandLeastAt(114, "Starport3"),Deaths(P10, Exactly, Starport_gen[i] * SDspeed, 19)}, {SetScanImage(971)})
CSPlot(PA, P6, 33, "Starport3", nil, 1, 64, P5, {CommandLeastAt(114, "Starport3"), Deaths(P10, Exactly, Starport_gen[i] * SDspeed, 19)})
...
for e = 2, 12, 4 do
Trigger2(P6, {CommandLeastAt(114, "Starport3"),Deaths(P10, Exactly, Starport_gen[e] * SDspeed, 19)}, {SetScanImage(971)})
CSPlot(PE, P6, 33, "Starport3", nil, 1, 64, P5, {CommandLeastAt(114, "Starport3"), Deaths(P10, Exactly, Starport_gen[e] * SDspeed, 19)})
...
Trigger2(P6, {CommandLeastAt(114, "Starport3"),Deaths(P10, AtLeast, (Starport_gen[12] * SDspeed) + 1, 19)}, {SetScanImage(546)})
...
function Stargate_Gun(stargatename,destname, Deathvar)
Trigger2(P6, {CommandLeastAt(167, stargatename)}, {SetDeaths(P10, Add, 1, Deathvar)},preserved)
Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[1] * SDspeed) - 2, Deathvar)}, {SetScanImage(972)})
for i = 1,8,8 do
...
CSPlotOrder(PA, P5, 89, stargatename, nil, 1, 32, CSMakePolygon(6,1,0,61,1), 0, Patrol, destname,nil , 0, nil, P5, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateGenTime[i+7] * SDspeed, Deathvar)})	
...
CSPlotWithProperties(EllipseArr[7], P8, 16, stargatename, nil, 1, 64, P8, {CommandLeastAt(167, stargatename), Deaths(P10, AtLeast, StargateGenTime[i+6] * SDspeed, Deathvar)},nil,nil,StargateProperties)
CSPlotWithProperties(EllipseArr[8], P8, 51, stargatename, nil, 1, 64, P8, {CommandLeastAt(167, stargatename), Deaths(P10, AtLeast, StargateGenTime[i+7] * SDspeed, Deathvar)},nil,nil,StargateProperties)
...
CSPlotWithProperties(LGU1, P8, 16, stargatename, nil, 1, 64, P8, {CommandLeastAt(167, stargatename), Deaths(P10, AtLeast, StargateGenTime[i+3] * SDspeed, Deathvar)},nil,nil,StargateProperties)
CSPlotOrder(PA, P5, 89, stargatename, nil, 1, 32, CSMakePolygon(6,1,0,61,1), 0, Patrol, destname,nil , 0, nil, P5, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateGenTime[i+4] * SDspeed, Deathvar)})
...
Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[21] * SDspeed) + 5, Deathvar)}, {SetScanImage(546)})

CSPlotOrder(PA, P5, 96, stargatename, nil, 1, 32, CSMakePolygon(6,1,0,61,1), 0, Patrol, destname,nil , 0, nil, P5, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateGenTime[22] * SDspeed, Deathvar)})
Trigger2(P6, {Deaths(P10, AtLeast, (StargateEftTime[1] * SDspeed)-5, Deathvar)}, {SetScanImage(213)})
...
CSPlot(StargateEft, P6, 33, stargatename, nil, 1, 32, P6,{CommandLeastAt(167, stargatename), Deaths(P10, AtLeast, StargateGenTime[23] * SDspeed, Deathvar)},{SetScanImage(546)})

CSPlotOrder(Cross1, P5, 66, stargatename, nil, 1, 32, CSMakePolygon(6,1,0,46,0), 0, Patrol, destname,nil , 0, nil, P5, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateGenTime[23] * SDspeed, Deathvar)})	
CSPlotOrder(Cross, P5, 65, stargatename, nil, 1, 32, CSMakePolygon(6,1,0,46,0), 0, Patrol, destname,nil , 0, nil, P5, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateGenTime[23] * SDspeed, Deathvar)})	
CSPlotOrder(Shape3, P5, 88, stargatename, nil, 1, 32, CSMakePolygon(6,1,0,54,24), 0, Patrol, destname,nil , 0, nil, P5, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateGenTime[23] * SDspeed, Deathvar)})	
CSPlotOrder(PA, P5, 89, stargatename, nil, 1, 32, PAA, 0, Attack, destname,nil , 0, nil, P5, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateGenTime[23] * SDspeed, Deathvar)})	
Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[23] * SDspeed) + 5, Deathvar)}, {SetScanImage(546)})

CSPlotOrder(PA, P6, 88, stargatename, nil, 1, 64, PAA, 0, Patrol, destname,nil , 0, nil, P6, {CommandLeastAt(114, "Starport3"),Deaths(P10, AtLeast, StargateGenTime[24] * SDspeed, Deathvar)})

---- after effects ---

Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[25] * SDspeed) - 2, Deathvar)}, {SetScanImage(972)})
...
CSPlotWithProperties(LGU4, P8, 16, stargatename, nil, 1, 64, P8, {CommandLeastAt(167, stargatename), Deaths(P10, AtLeast, StargateGenTime[25] * SDspeed-1, Deathvar)},nil,nil,StargateProperties)
...
CSPlotOrder(PB, P5, 89, stargatename, nil, 1, 32, CSMakePolygon(6,1,0,37,1), 0, Patrol, destname,nil , 0, nil, P5, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateGenTime[25] * SDspeed, Deathvar)})	
...
Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[25] * SDspeed) + 1, Deathvar)}, {SetScanImage(546)})
...
Trigger2(P6, {CommandLeastAt(167, stargatename),Deaths(P10, AtLeast, StargateEftTime[4] * SDspeed + 1,Deathvar)}, {SetScanImage(546)})


---- after 2nd effects ----

Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[27] * SDspeed) - 2, Deathvar)}, {SetScanImage(972)})
for i = 27,27 do
    ...
    CSPlotWithProperties(EllipseArr[7], P8, 16, stargatename, nil, 1, 64, P8, {CommandLeastAt(167, stargatename), Deaths(P10, AtLeast, StargateGenTime[i] * SDspeed - 1, Deathvar)},nil,nil,StargateProperties)
    CSPlotWithProperties(EllipseArr[8], P8, 51, stargatename, nil, 1, 64, P8, {CommandLeastAt(167, stargatename), Deaths(P10, AtLeast, StargateGenTime[i] * SDspeed - 1, Deathvar)},nil,nil,StargateProperties)
    ...
    Trigger2(P6,{CommandLeastAt(167, stargatename),Deaths(P10, Exactly, StargateGenTime[i] * SDspeed, Deathvar) }, {GiveUnits(All,"Men" , P8, "Anywhere", P5),SetInvincibility(Disable, "Men", P5, "Anywhere"),Order("Men", P5, "Anywhere", Attack, stargatename)})
end
Trigger2(P6, {Deaths(P10, AtLeast, (StargateGenTime[27] * SDspeed) + 1, Deathvar)}, {SetScanImage(546)})
end

---- call stargate func ----
local stargatename = "Stargate1"
local destname = "etcPhysics"
local Deathvar = 20

Stargate_Gun(stargatename, destname, Deathvar)

local stargatename = "Stargate2"
local destname = "etcAcademy3"
local Deathvar = 21

Stargate_Gun(stargatename, destname, Deathvar)

local stargatename = "Stargate3"
local destname = "etcPhysics1"
local Deathvar = 22

Stargate_Gun(stargatename, destname, Deathvar)

local stargatename = "Stargate4"
local destname = "etcArbiter"
local Deathvar = 23

Stargate_Gun(stargatename, destname, Deathvar)

--- end of stargate building functions ---


--- start of factory buiding functions data + deathvar start 25 ---
function Factory_gundata(factoryname, destname, deathvar)
...
Trigger2(P6, {CommandLeastAt(113, factoryname)}, {SetDeaths(P10, Add, 1, deathvar)},preserved)
-- Trigger2(P6, {CommandLeastAt(113, factoryname), Deaths(P10, AtLeast, 4, deathvar)}, {CSPlot(CS_SortR(CS_FillRA(1,{0,math.sqrt(SYmax^2+SXmax^2)},{0,360},32,16),1),P1,33,factoryname,nil,1,32,P1)})

CSPlotOrder(PA, P6, 19, factoryname, nil, 1, 32, PAA, 0, Attack, factoryname, nil, 0, nil, P6, {CommandLeastAt(113, factoryname),Deaths(P10, AtLeast, 12, deathvar)},nil, nil)
end


local factoryname = "Factory1"
local destname = "bunkerHeal"
local deathvar = 25
Factory_gundata(factoryname, destname, deathvar)
